...
export default {
  ...
  data() {
    return {
      ...
      set_assert: this.options.charAt(5) == "1" ? true : false,
      show_assert: this.options.charAt(6) == "1" ? true : false
    };
  },
  methods: {
    sendCommand(e) {
  ...
  watch: {
    options(newValue, oldValue) {
      ...
      this.set_assert = newValue.charAt(5) == "1" ? true : false;
      this.show_assert = newValue.charAt(6) == "1" ? true : false;
    }
  }
};
</script>